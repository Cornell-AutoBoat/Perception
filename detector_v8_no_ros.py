...
def main():
    ...
    capture_thread = Thread(target=torch_thread, kwargs={
                            'weights': 'weights/yolov8L-10-22-2023.pt', 'img_size': 416, "conf_thres": 0.3})
    ...
    track_view_generator = cv_viewer.TrackingViewer(
        tracks_resolution, camera_config.fps, init_params.depth_maximum_distance)
...
if __name__ == '__main__':
    ...
    #                     default='yolov8m.pt', help='model.pt path(s)')
